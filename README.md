<h1 align="center">
  <img src='https://github.com/AO-Innovators/react-native-boilerplate/blob/main/__DELELE_ME__/banner.png' width='600'>
</h1>

<p align="center">
  <img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="React Native is released under the MIT license." />
  <img src="https://github.com/AO-Innovators/react-native-boilerplate/actions/workflows/preview.yml/badge.svg" alt="" />
  <img src="https://github.com/AO-Innovators/react-native-boilerplate/actions/workflows/test.yml/badge.svg" alt="" />
  <img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg" alt="PRs welcome!" />
</p>

<p align="center">
  <img src='https://github.com/AO-Innovators/react-native-boilerplate/blob/main/__DELELE_ME__/demo-light-theme.gif' width='150px'>
  <img src='https://github.com/AO-Innovators/react-native-boilerplate/blob/main/__DELELE_ME__/demo-dark-theme.gif' width='150px'>
</p>
...
#### Getting Started
1. Explore existing slices in the [`/slices`](https://github.com/AO-Innovators/react-native-boilerplate/tree/main/slices) directory
2. See usage examples in [`/app/_layout.tsx`](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/app/_layout.tsx#L23)

#### Adding New State
1. Copy [`/slices/app.slice.ts`](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/slices/app.slice.ts)
2. Rename and modify for your needs
3. Add your slice to [`/utils/store.ts`](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/utils/store.ts#L10)

#### Development
Redux logger is enabled by default. To disable, remove the logger from [`/utils/store.ts`](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/utils/store.ts#L13).
...
- Configuration in [`app.config.ts`](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/app.config.ts) and [`utils/config.ts`](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/utils/config.ts)

#### Getting Started with Your Expo Account
1. Rename `.env.dev.example` to `.env.dev`
2. Update `owner` in [`app.json`](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/app.json#L6) with your Expo username
3. Set your `EXPO_SLUG` and `EXPO_PROJECT_ID` in `.env.dev`

#### Adding New Environment Variables
1. Add variables to both `.env.dev` and `.env.prod`
2. Include them in `app.config.ts` under the [`extra`](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/app.config.ts#L29) object
3. Define them in [`utils/config.ts`](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/utils/config.ts#L6)
...
3. The continuous delivery (CD) process is managed through the [preview.yml](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/.github/workflows/preview.yml) configuration file, which utilizes [expo-github-action](https://github.com/expo/expo-github-action).
...
3. Update `name`, `slug`, `owner`, `projectId` and `url` in [app.json](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/app.json):
4. Update in `name`, `slug`, `projectId`, `ios`, `android` in [app.config.ts](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/app.config.ts)
...
This project is available under the MIT license. See the [LICENSE](https://github.com/AO-Innovators/react-native-boilerplate/blob/main/LICENSE) file for more info.